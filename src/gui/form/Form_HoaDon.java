...
public class Form_HoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnTim.setIcon(new ImageIcon(Form_HoaDon.class.getResource("/image/icon/search_white.png"))); // NOI18N
        ...
        btnLamMoi.setIcon(new ImageIcon(Form_HoaDon.class.getResource("/image/icon/reload.png"))); // NOI18N
        ...
        btnChiTiet.setBackground(new Color(43, 123, 255));
        btnChiTiet.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnChiTiet.setForeground(new java.awt.Color(255, 255, 255));
        btnChiTiet.setIcon(new ImageIcon(Form_HoaDon.class.getResource("/image/icon/bill_details.png"))); // NOI18N
        ...
        btnXoaRong.setIcon(new ImageIcon(Form_HoaDon.class.getResource("/image/icon/close_white.png"))); // NOI18N
        ...
        btnXoa.setIcon(new ImageIcon(Form_HoaDon.class.getResource("/image/icon/bin_white.png"))); // NOI18N
        btnXoa.setText("Xóa ");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtMaHoaDon, javax.swing.GroupLayout.DEFAULT_SIZE, 257, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtNgayLHD, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setHorizontalGroup(
        	jPanel2Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			.addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 1459, Short.MAX_VALUE)
        			.addContainerGap())
        );
        	...
        	layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.TRAILING)
        				.addComponent(jPanel2, GroupLayout.DEFAULT_SIZE, 1473, Short.MAX_VALUE)
        				.addComponent(jPanel1, GroupLayout.DEFAULT_SIZE, 1473, Short.MAX_VALUE))
        			.addContainerGap())
        );
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addComponent(jPanel2, GroupLayout.DEFAULT_SIZE, 447, Short.MAX_VALUE))
        );
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        try {
            ...
            if (index >= 0 && index < dshoadon.size()) {
                ...
                int dialogResult = JOptionPane.showConfirmDialog(this, "Bạn có muốn xóa hoá đơn này không", "Xác thực", dialogButton);
                if (dialogResult == 0) {
                    String maHD = dshoadon.get(index).getMaHoaDonBan();
                    System.out.println(maHD);
                    daoCTHD.xoaCTHoaDon(maHD);
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
    	if(txtMaHoaDon.getText().equals("")) {
    		JOptionPane.showMessageDialog(this,"Mã hóa đơn không được bỏ trống!", "Warning", JOptionPane.WARNING_MESSAGE);
    	}
