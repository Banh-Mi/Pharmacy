...
//	DAO_CongDung dao_CongDung = new DAO_CongDung();
	...
	public Form_ChiTiet(String maThuoc) {
		initComponents();
	...
	private void docThongTinThuocLenFrame(String maThuoc) {
		Thuoc t = daot.getThuocTheoMa(maThuoc);
		...
		txtTenThuoc.setText(t.getTenThuoc());
                txtNhomCongDung.setText("<html>"+t.getCongDung().getNhomCongDung()+"</html>");
		txtCongDung.setText("<html>"+t.getCongDung().getCongDung()+"</html>");
		...
		txtVat.setText(String.valueOf(t.getThueVAT()*100));
		txtSoDK.setText(t.getSoDK());
		txtSLTon.setText("" + t.getSoLuongBanDau());
		...
		txtNuocSX.setText(t.getNuocSanXuat());
                String giaformat= String.format("%,.0f", t.getGiaBan());
		txtGia.setText(giaformat+ " VNĐ");
...
//        btnDong.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tick .png"))); // NOI18N
	...
	private void btnDongActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDongActionPerformed
		Form_ChiTiet.setDefaultLookAndFeelDecorated(true);
		dispose();
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Form_ChiTiet.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
