...
//        getTatCaHoaDonTheoNgayCuaQuanLi(dateFormat.format(dcNgay.getDate()));
        ...
        cbbLoaiThongKe.setEnabled(false);
        tableNhanVien.setEnabled(false);
    ...
    private void btnThongKeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThongKeActionPerformed
        if (tabbedPane.getSelectedIndex() == 0) {
            ...
            if (cbbLoaiThongKe.getSelectedIndex() != 0) {
                getHoaDonCuaNhanVienTheoNgay(ngayStr,nhanVienThongKe.getMaNV());
            } else {
//                getTatCaHoaDonTheoNgayCuaQuanLi(ngayStr);
            }
        } else if (tabbedPane.getSelectedIndex() == 1) {
            thongKeThang(nhanVienThongKe.getMaNV());
        } else if (tabbedPane.getSelectedIndex() == 2) {
            thongKeNam(nhanVienThongKe.getMaNV());
        }
...
//                exportExcel(tableThongkeThuocNgay, modelThongKeThuocTheoNgay, "ThuocBanTrongNgayCuaQuanLy");
    ...
    private void getHoaDonCuaNhanVienTheoNgay(String ngay, String maNV) {
        modelThongKeThuocTheoNgay = (DefaultTableModel) tableThongkeThuocNgay.getModel();
    ...
    private void thongKeThang(String maNV) {
        ...
        ChartPanel chartPanel = new ChartPanel(createChartThang(thang, maNV));
    ...
    private void thongKeNam(String maNV) {
        ...
        ChartPanel chartPanel = new ChartPanel(createChartNam(nam,maNV));
        pnelTKNam.add(chartPanel);
    }

    private JFreeChart createChartNam(String nam, String maNV) {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
